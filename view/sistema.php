...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../estilo/sistema.css">
            ...
            <div class="mainCardHeader"><?php if(isset($_SESSION['idUser']) && !empty($_SESSION['idUser'])){ echo ''.$_SESSION['nome_pro']. ' conectado ';} ?></div>
                ...
                <form action="../controller/sistema.php" method="POST">
                    <button class="miniCard" id="icone" type="submit" name="acao" value="diarios"><br>
                        <label for="">DIARIOS</label>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-journal" viewBox="0 0 16 16">
                        <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z"/>
                        <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z"/>
                       </svg>
                       
                    </button>
                    <button class="miniCard" id="icone" type="submit" name="acao" value="professores">
                    ...
                    <button class="miniCard" id="icone" type="submit" name="acao" value="alunos"><br>
                    ...
                    <button class="miniCard" type="submit" name="acao" value="ponto"><br>
                    ...
                    <div class="mainCardContent"></div>
                    <button class="miniCard" id="icone" type="submit" name="acao" value="addAluno">
                        <label for="">CADASTRAR</label>
                        <label for="">ALUNO</label>
                        <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                        <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917l-7.5-3.5Z"/>
                        <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Z"/>
                        </svg>

                    </button>
                    <button class="miniCard" type="submit" name="acao" value="addProfessor">
                    ...
                    <button class="miniCard" id="icone" type="submit" name="acao" value="informacao"><br>
                    ...
                    <button class="miniCard" type="submit" name="acao" value="sair"><br>
                        <label for="">SAIR</label>
                        <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
